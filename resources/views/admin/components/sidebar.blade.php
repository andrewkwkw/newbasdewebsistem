            ...
            <ul class="space-y-1.5">
                ...
                <li>
                    <a href="{{ route('jenis_sampah') }}"
                        ...
                        <i
                            class="fas fa-box w-5 h-5 flex items-center justify-center transition duration-75 {{ request()->routeIs('jenis_sampah') ? 'text-white' : 'text-gray-400 group-hover:text-gray-900' }}"></i>
                        <span class="ml-3">Jenis Sampah</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('viewcreate') }}"
                        class="flex items-center p-3 text-sm font-semibold rounded-xl group transition-all duration-200 {{ request()->routeIs('viewcreate') ? 'bg-indigo-600 text-white shadow-md shadow-indigo-200' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                        <i
                            class="fas fa-plus-circle w-5 h-5 flex items-center justify-center transition duration-75 {{ request()->routeIs('viewcreate') ? 'text-white' : 'text-gray-400 group-hover:text-gray-900' }}"></i>
                        <span class="ml-3">Setor Manual</span>
                    </a>
                </li>
                <li>
