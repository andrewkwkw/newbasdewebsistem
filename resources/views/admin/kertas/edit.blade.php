...
@section('title', 'Edit Data Kertas')
        ...
        <section class="section">
            <div class="section-header">
                <div class="section-header-back">
                    <a href="{{ route('sampah-kertas.index') }}" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>ID Data - {{ $kertas->id }}</h4>
                            </div>
                            <form method="POST" id="myForm" name="vform" onsubmit="return Validate()"
                                action="{{ route('sampah-kertas.update', $kertas->id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="form-group ml-4 mr-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="berat" placeholder="Ketik disini"
                                            ...
                                            onchange="updateNominal()" value="{{ $kertas->berat }}">
                                    </div>
                                </div>
                                <div class="form-group ml-4 mr-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="nominal_per_gram" placeholder="Ketik disini"
                                            ...
                                            onchange="updateNominal()" value="{{ $kertas->nominal_per_gram }}">
                                    </div>
                                </div>
                                <div class="form-group ml-4 mr-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="nominal" required class="form-control phone-number currency" style="display: none" value="{{ $kertas->nominal }}">
                                        <input type="text" name="totalNominal" placeholder="Total Nominal" required
                                            class="form-control phone-number currency"
                                            value="{{ number_format($kertas->nominal, 0, ',', '.') }}" disabled>
                                    </div>
                                </div>
