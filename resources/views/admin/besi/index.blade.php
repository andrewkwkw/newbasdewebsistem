                                    ...
                                    <table class="table-striped table">
                                        ...
                                        @foreach ($allData as $data)
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="{{ route('sampah-besi.destroy', $data->id) }}"
                                                        method="POST">
                                                        <a type="button" class="btn btn-primary" href="{{ route('sampah-besi.edit', $data->id) }}"><i class="fa-regular fa-pen-to-square"></i></a>
                                                        @csrf
                                                        @method('DELETE')
