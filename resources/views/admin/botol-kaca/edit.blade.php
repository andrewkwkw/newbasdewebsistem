...
@section('title', 'Edit Data Botol Kaca')
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>ID Data - {{ $botol_kaca->id }}</h4>
                            </div>
                            <form method="POST" id="myForm" name="vform" onsubmit="return Validate()"
                                action="{{ route('sampah-botol-kaca.update', $botol_kaca->id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="form-group ml-4 mr-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="berat" placeholder="Ketik disini"
                                            ...
                                            onchange="updateNominal()" value="{{ $botol_kaca->berat }}">
                                    </div>
                                </div>
                                <div class="form-group ml-4 mr-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="nominal_per_gram" placeholder="Ketik disini"
                                            ...
                                            onchange="updateNominal()" value="{{ $botol_kaca->nominal_per_gram }}">
                                    </div>
                                </div>
                                <div class="form-group ml-4 mr-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="nominal" required class="form-control phone-number currency" style="display: none" value="{{ $botol_kaca->nominal }}">
                                        <input type="text" name="totalNominal" placeholder="Total Nominal" required
                                            class="form-control phone-number currency"
                                            value="{{ number_format($botol_kaca->nominal, 0, ',', '.') }}" disabled>
                                    </div>
                                </div>
